  ...
  <div class="card-body pt-3 pb-2">
    <div class="lead--small">
      <div class="pl-4">
        ...
        <p class="mb-2  @if(!is_null($logos) and $logos->is_finished) @else text-black-25 @endif 
          "><i class=" pr-2 fa fa-check-circle 
          @if(!is_null($logos) and $logos->is_finished)
            text-success
          @else
            text-black-25
          @endif "></i>
        ...
        {{-- <p class="mb-2  @if(!is_null($user->keybase)) @else text-black-25 @endif 
          "><i class=" pr-2 fa fa-check-circle 
