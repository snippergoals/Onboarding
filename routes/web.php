...
Route::group(['middleware' => ['auth']], function (){
    ...
    Route::get('/stats', 'HomeController@stats')->name('customer.stats');
    ...
    Route::post('logos/upload', 'AssetController@uploadLogos')->name('logos.upload');
    ...
    Route::post ( '/keybase', 'HomeController@keybase')->name('keybase');
    Route::get ( '/close-video', 'HomeController@close_video')->name('close_video');
...
Route::group(['middleware' => ['auth'], 'prefix' => 'admin'], function (){
    ...
    Route::post('customer/{user}/review-logos/{answer}','Admin\CustomerController@postLogosReview')->name('admin.review-logos');
    Route::post('customer/{user}/review-logos','Admin\CustomerController@postEmptyLogosReview')->name('admin.review-empty-assets');
    ...
    Route::get('customers/{user}/remove_keybase', 'Admin\CustomerController@remove_keybase')->name('admin.remove_keybase');
    ...
    Route::post('survey/update-section', 'SurveyController@updateSurvey')->name('admin.updatesection');
    Route::post('survey/update-question', 'QuestionController@updateQuestion')->name('admin.updatesection');
    Route::post('survey/delete-question', 'QuestionController@deleteQuestion')->name('admin.updatesection');
    Route::post('survey/update-all', 'SurveyController@updateSurveyOrder')->name('admin.updatesurvey');
