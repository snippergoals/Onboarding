...
use App\Mail\PrototypeReceivedMailable;
...
class CustomerController extends Controller
{
    ...
    public function show(User $user)
    {
        ...
        $logos = Answer::query()->where('type', 'logo')->where('user_id', $user->id)->first();
        ...
        return view('admin.customers.show', compact('surveys', 'surveyProgress', 'user', 'logos', 'assets', 'prototype', 'services', 'tickets'));
    }
     ...
     * @return \Illuminate\Http\RedirectResponse
     */
    public function postLogosReview(Request $request, User $user, Answer $answer)
    {
        $data = [];
        ...
        $this->notifications->create($user, [
            'icon' => 'fa-photo',
            'body' => 'Your logos have been reviewed',
     ...
     * @return \Illuminate\Http\RedirectResponse
     */
    public function postEmptyLogosReview(Request $request, User $user)
    {
    ...
    public function markReceived(Request $request, User $user, Answer $answer)
    {
        ...
        $this->notifications->create($user, [
            'icon' => 'fa-diamond',
            'body' => 'Your prototype has been received.',
            'action_text' => 'Go to Dashboard',
            'action_url' => '/home',
        ]);

        Mail::to($user)->send(new PrototypeReceivedMailable($answer));
     ...
     *
     */
    public function remove_keybase(Request $request, User $user)
    {
        $user->update([
            'keybase' => 'This information has been recorded and removed.'
        ]);

        session()->flash('message', 'The Payment Information Has Been Deleted!');
